...
@Slf4j
@AllArgsConstructor
public class GetPriceBtcCommand implements IBotCommand {

    private final PriceCurrencyService priceCurrencyService;

    @Override
    public String getCommandIdentifier() {
        return "get_price_BTC";
    }
    ...
    public void processMessage(AbsSender absSender, Message message, String[] arguments) {
        ...
        try {
            answer.setText("Текущая цена биткоина " +
                    TextUtil.toString(priceCurrencyService.getBitcoinPrice()) + " USD");
//            log.error("создан лог с прайсом " + answer.getChatId());
